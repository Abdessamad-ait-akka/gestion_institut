...
oauth.register(
    ...
    client_kwargs={
        ...
        # 'code_challenge_method': 'S256' # enable PKCE (fixed typo from '5256')
    },
...
@app.route("/")  
def home():
    return render_template("achraf.html", session=session.get("user") , 
